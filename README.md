...
Experimental on-console HID driver focusing on providing third party controller support (and attempting other HID devices) to the Xbox 360 without USB patches or dongles.
